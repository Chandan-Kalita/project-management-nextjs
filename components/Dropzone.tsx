...
export default function MyDropzone({heading, fieldToShow}:{heading?:string, fieldToShow:any}) {
    ...
    return (
        ...
        <div className='p-2'>
            ...
            />
            {!fieldToShow ||(fieldToShow && ["photo","address_proof","income_proof"].some(r=>fieldToShow.includes(r))) ? <Typography variant='h6' className='pb-5'>{heading?heading:"Upload Documents"}</Typography>:""}
            <div className='grid grid-cols-2 gap-y-3 gap-x-[100px]'>
            {!fieldToShow || (fieldToShow && fieldToShow.includes("photo")) ? <div className="flex items-center justify-between">
                ...
                {!fieldToShow || (fieldToShow && fieldToShow.includes("address_proof")) ?     <div className="flex items-center justify-between">
                ...
                {!fieldToShow || (fieldToShow && fieldToShow.includes("income_proof")) ?<div className="flex items-center justify-between">
